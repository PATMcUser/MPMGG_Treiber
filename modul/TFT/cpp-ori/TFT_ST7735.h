...
#define TFT_CS_L	digitalWrite(_cs, LOW)
//#define TFT_DC_C 	FastPin<TFT_DC>::lo()
#define TFT_DC_C 	digitalWrite(_dc, LOW)
//#define TFT_CS_H	FastPin<TFT_CS>::hi()
#define TFT_CS_H	digitalWrite(_cs, HIGH)
//#define TFT_DC_D 	FastPin<TFT_DC>::hi()
#define TFT_DC_D 	digitalWrite(_dc, HIGH)
...
class TFT_ST7735 : public Print {
 ...
 public:
  ...
  TFT_ST7735(uint8_t CS, uint8_t DC, uint8_t RST, int16_t _W = ST7735_TFTWIDTH, int16_t _H = ST7735_TFTHEIGHT);
